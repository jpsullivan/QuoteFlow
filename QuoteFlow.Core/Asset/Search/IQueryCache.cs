...
namespace QuoteFlow.Core.Asset.Search
{
    ...
    public interface IQueryCache
    {
        ...
        /// for the <see cref="User"/> <see cref="IQuery"/> pair.
        /// </summary>
        ...
        /// <see cref="User"/> <see cref="IQuery"/> pair in the current thread, or null if
        ...
        /// <see cref="User"/> <see cref="IQuery"/> pair. The cache result
        ...
        /// <see cref="User"/> <see cref="IQuery"/> </param>
        ...
        /// <see cref="User"/><see cref="Query"/> pair in the current thread, or null if
        /// the operation has yet to be performed. </returns>
        ...
        /// <summary>
        /// Retrieve the collection of <see cref="com.atlassian.jira.jql.ClauseHandler"/>s registered
        /// for the <see cref="User"/> jqlClauseName pair.
        /// </summary>
        /// <param name="searcher"> the user who is performing the search </param>
        /// <param name="jqlClauseName"> the jQLClauseName for which to find the result for; cannot be null. </param>
        /// <returns> the collection of <see cref="IClauseHandler"/>s registered
        /// for the <see cref="User"/> jqlClauseName pair. </returns>
        List<IClauseHandler> GetClauseHandlers(User searcher, string jqlClauseName);

        /// <summary>
        /// Set the cached result of a getSimpleQueryContext operation on the
        /// <see cref="User"/> <see cref="com.atlassian.query.Query"/> pair. The cache result
        /// is only held for the current thread.
        /// </summary>
        /// <param name="searcher">The user who is performing the search </param>
        /// <param name="jqlClauseName">The jQLClauseName for which to store the result under; cannot be null. </param>
        /// <param name="clauseHandlers">The collection of <see cref="IClauseHandler"/>s
        /// <see cref="User"/> <see cref="IClauseHandler"/> </param>
        void SetClauseHandlers(User searcher, string jqlClauseName, ICollection<IClauseHandler> clauseHandlers);

        /// <summary>
        /// Retrieve the list of <see cref="QueryLiteral"/>s registered
        /// for the <see cref="IQueryCreationContext"/> <see cref="IOperand"/> jqlClause triplet.
        /// 
        /// </summary>
        ...
        /// <returns> the list of <see cref="QueryLiteral"/>s registered
        /// for the <see cref="QueryCreationContext"/> jqlClause pair. </returns>
        ...
        /// <param name="values">The collection of <see cref="QueryLiteral"/>s </param>
