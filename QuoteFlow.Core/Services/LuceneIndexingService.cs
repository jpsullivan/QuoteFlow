...
namespace QuoteFlow.Core.Services
{
    public class LuceneIndexingService : IIndexingService
    {
        ...
        private static ConcurrentDictionary<Directory, IndexWriter> WriterCache = new ConcurrentDictionary<Directory, IndexWriter>();

        private global::Lucene.Net.Store.Directory _directory;
