...
// $ANTLR 3.5.0.2 C:\\Users\\jaysc_000\\Documents\\GitHub\\QuoteFlow\\QuoteFlow.Core\\Jql\\Parser\\Antlr\\Jql.g 2015-11-23 22:00:55
	...
	private void mEMPTY()
	{
		...
		try
		{
			...
			case 2:
				...
				DebugLocation(919, 76);
				input.Consume();

				DebugLocation(919, 85);
				input.Consume();
	...
	private void mESCAPE()
	{
		...
		try
		{
			...
			case 8:
				...
				Match('u'); 
				DebugLocation(1063, 20);
				mHEXDIGIT(); 
				DebugLocation(1063, 29);
				mHEXDIGIT(); 
				DebugLocation(1063, 38);
				mHEXDIGIT(); 
				DebugLocation(1063, 47);
				mHEXDIGIT(); 
