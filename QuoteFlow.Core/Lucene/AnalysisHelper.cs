...
namespace QuoteFlow.Core.Lucene
{
    internal class AnalysisHelper
    {
        ...
        public static Query GetFieldQuery(Analyzer analyzer, string field, string queryText)
        {
        ...
        public static Query GetMultiFieldQuery(Analyzer analyzer, IEnumerable<string> fields, string queryText)
        {
