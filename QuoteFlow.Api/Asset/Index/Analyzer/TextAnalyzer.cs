...
{
    /// <summary>
    /// Analyzereld.Index.Analyzer"/> base class that provides the facility to apply the <see cref="SubtokenFilter"/>
    ...
    public abstract class TextAnalyzer : global::Lucene.Net.Analysis.Analyzer
    {
        ...
        /// <summary>
        /// Applies a <see cref="SubtokenFilter"/> to the input token stream at document indexing time.
        /// </summary>
        ...
        /// <summary>
        /// Applies a <see cref="KeywordRepeatFilter"/> to the input token stream at document indexing time to store the original
