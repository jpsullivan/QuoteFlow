...
namespace QuoteFlow.Api.Asset.Index.Indexers
{
    ...
    {
        internal virtual Field.Index Unanalyzed(Models.Asset asset)
        {
        ...
        public virtual void IndexKeyword(Document doc, string indexField, string fieldValue, Models.Asset asset)
        {
        ...
        /// </summary>
        public virtual void IndexKeywordWithDefault(Document doc, string indexField, string fieldValue, string defaultValue, Models.Asset asset)
        {
            FieldIndexerUtil.IndexKeywordWithDefault(doc, indexField, fieldValue, defaultValue, IsFieldVisibleAndInScope(asset));
        }

        public virtual void IndexKeywordWithDefault(Document doc, string indexField, long? aLong, string defaultValue, Models.Asset asset)
        {
        ...
        /// </summary>
        public virtual void IndexText(Document doc, string indexField, string fieldValue, Models.Asset asset)
        {
            if (fieldValue.HasValue())
            {
        ...
        /// </summary>
        public virtual void IndexDateField(Document doc, string indexField, DateTime date, Models.Asset asset)
        {
        ...
        /// Index a single text field
        /// </summary>
        public virtual void IndexTextForSorting(Document doc, string indexField, string fieldValue, Models.Asset asset)
        {
        ...
        public abstract void AddIndex(Document doc, Models.Asset asset);

        public virtual bool IsFieldVisibleAndInScope(Models.Asset asset)
        {
            return true;
        }
    }
