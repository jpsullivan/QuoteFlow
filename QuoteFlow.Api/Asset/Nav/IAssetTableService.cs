...
namespace QuoteFlow.Api.Asset.Nav
{
    ...
    public interface IAssetTableService
    {
        ...
        /// <returns></returns>
        AssetTableViewModel GetIssueTableFromFilterWithJql(string filterId, string jql,
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        AssetTableViewModel GetAssetTableFromAssetIds(string filterId, string jql, List<int> ids,
