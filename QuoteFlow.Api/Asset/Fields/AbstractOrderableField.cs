...
namespace QuoteFlow.Api.Asset.Fields
{
    public abstract class AbstractOrderableField : AbstractField, IOrderableField
    {
        ...
        public void PopulateDefaults(IDictionary<string, object> fieldValuesHolder, Models.Asset asset)
        {
        ...
        public void PopulateFromAsset(IDictionary<string, object> fieldValuesHolder, Models.Asset asset)
        {
            throw new NotImplementedException();
        }

        public bool HasValue(Models.Asset asset)
        {
            throw new NotImplementedException();
        }
        ...
        public void PopulateParamsFromString(IDictionary<string, object> fieldValuesHolder, string stringValue, Models.Asset asset)
        {
            throw new NotImplementedException();
        }
    }
