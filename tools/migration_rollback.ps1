...
& $FluentMigratorExePath /connection "Data Source=(local);Initial Catalog=QuoteFlow;Integrated Security=SSPI;" /provider sqlserver2012 /assembly $QuoteFlowDLLPath --task rollback --steps $steps
