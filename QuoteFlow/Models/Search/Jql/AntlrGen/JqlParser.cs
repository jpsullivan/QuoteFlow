...
public partial class JqlParser : Antlr.Runtime.Parser
{
	...
	// $ANTLR start "query"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:191:1: query returns [IClause clause, IOrderBy order] : (where= clause )? (sort= orderBy )? EOF ;
	[GrammarRule("query")]
	private JqlParser.query_return query()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:2: ( (where= clause )? (sort= orderBy )? EOF )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:4: (where= clause )? (sort= orderBy )? EOF
			{
			DebugLocation(192, 4);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:4: (where= clause )?
			int alt1=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:5: where= clause
				{
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:23: (sort= orderBy )?
			int alt2=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:192:24: sort= orderBy
				{
	...
	// $ANTLR start "clause"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:231:1: clause returns [IClause clause] : orClause ;
	[GrammarRule("clause")]
	private IClause clause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:232:2: ( orClause )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:232:4: orClause
			{
			DebugLocation(232, 4);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:238:1: orClause returns [IClause clause] : cl= andClause ( OR cl= andClause )* ;
	...
	private IClause orClause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:243:2: (cl= andClause ( OR cl= andClause )* )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:243:4: cl= andClause ( OR cl= andClause )*
			{
			DebugLocation(243, 7);
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:243:48: ( OR cl= andClause )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:243:49: OR cl= andClause
					{
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:249:1: andClause returns [IClause clause] : cl= notClause ( AND cl= notClause )* ;
	...
	private IClause andClause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:253:2: (cl= notClause ( AND cl= notClause )* )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:253:4: cl= notClause ( AND cl= notClause )*
			{
			DebugLocation(253, 7);
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:253:48: ( AND cl= notClause )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:253:49: AND cl= notClause
					{
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:259:1: notClause returns [IClause clause] : ( ( NOT | BANG ) nc= notClause | subClause | terminalClause );
	...
	private IClause notClause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:260:2: ( ( NOT | BANG ) nc= notClause | subClause | terminalClause )
			int alt5=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:260:4: ( NOT | BANG ) nc= notClause
				{
				DebugLocation(260, 4);
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:261:4: subClause
				{
				DebugLocation(261, 4);
			...
			case 3:
				DebugEnterAlt(3);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:262:25: terminalClause
				{
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:274:1: subClause returns [IClause clause] : LPAREN orClause RPAREN ;
	...
	private IClause subClause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:275:5: ( LPAREN orClause RPAREN )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:275:7: LPAREN orClause RPAREN
			{
			DebugLocation(275, 7);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:292:1: terminalClause returns [IClause clause] : f= field op= operator ( (opand= operand (pred= historyPredicate )? ) | (chPred= historyPredicate )? ) ;
	...
	private IClause terminalClause()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:2: (f= field op= operator ( (opand= operand (pred= historyPredicate )? ) | (chPred= historyPredicate )? ) )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:4: f= field op= operator ( (opand= operand (pred= historyPredicate )? ) | (chPred= historyPredicate )? )
			{
			DebugLocation(293, 6);
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:29: ( (opand= operand (pred= historyPredicate )? ) | (chPred= historyPredicate )? )
			int alt8=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:31: (opand= operand (pred= historyPredicate )? )
				{
				DebugLocation(293, 31);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:31: (opand= operand (pred= historyPredicate )? )
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:32: opand= operand (pred= historyPredicate )?
				{
				...
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:52: (pred= historyPredicate )?
				int alt6=2;
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:75: (chPred= historyPredicate )?
				{
				DebugLocation(293, 81);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:293:81: (chPred= historyPredicate )?
				int alt7=2;
			...
			DebugLocation(294, 2);
			        ...
			        if (f != null && (f!=null?((JqlParser.field_return)f).field:default(FieldReference)).IsEntityProperty())
			        {
			            ...
			            clause = new ITerminalClause((f!=null?((JqlParser.field_return)f).field:default(FieldReference)).Name, op, opand, Option.some((f!=null?((JqlParser.field_return)f).field:default(FieldReference)).getProperty()));
			        }
				    else if (op  == Operator.CHANGED)
				    {
			            ...
			            clause = new IChangedClause((f!=null?((JqlParser.field_return)f).field:default(FieldReference)).Name, op, chPred);
				    }
				    else
				    {
				       if (op == Operator.WAS || op == Operator.WAS_NOT || op == Operator.WAS_IN || op == Operator.WAS_NOT_IN )
					   {
			                ...
			                clause = new IWasClause((f!=null?((JqlParser.field_return)f).field:default(FieldReference)).Name, op, opand, pred);
			           ...
			           else
			           {
			                ...
			                clause = new ITerminalClause((f!=null?((JqlParser.field_return)f).field:default(FieldReference)).Name, op, opand);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:366:1: historyPredicate returns [IHistoryPredicate predicate] : (p= terminalHistoryPredicate )+ ;
	...
	private IHistoryPredicate historyPredicate()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:370:2: ( (p= terminalHistoryPredicate )+ )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:370:4: (p= terminalHistoryPredicate )+
			{
			DebugLocation(370, 4);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:370:4: (p= terminalHistoryPredicate )+
			int cnt9=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:370:5: p= terminalHistoryPredicate
					{
					DebugLocation(370, 7);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:434:1: terminalHistoryPredicate returns [IHistoryPredicate predicate] : historyPredicateOperator operand ;
	...
	private IHistoryPredicate terminalHistoryPredicate()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:435:2: ( historyPredicateOperator operand )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:435:4: historyPredicateOperator operand
			{
			DebugLocation(435, 4);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:442:1: historyPredicateOperator returns [Operator operator] : ( FROM | TO | BY | BEFORE | AFTER | ON | DURING );
	...
	private Operator historyPredicateOperator()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:443:2: ( FROM | TO | BY | BEFORE | AFTER | ON | DURING )
			int alt10=7;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:443:4: FROM
				{
				DebugLocation(443, 4);
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:444:4: TO
				{
				DebugLocation(444, 4);
			...
			case 3:
				DebugEnterAlt(3);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:445:4: BY
				{
				DebugLocation(445, 4);
			...
			case 4:
				DebugEnterAlt(4);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:446:4: BEFORE
				{
				DebugLocation(446, 4);
			...
			case 5:
				DebugEnterAlt(5);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:447:4: AFTER
				{
				DebugLocation(447, 4);
			...
			case 6:
				DebugEnterAlt(6);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:448:4: ON
				{
				DebugLocation(448, 4);
			...
			case 7:
				DebugEnterAlt(7);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:449:4: DURING
				{
				DebugLocation(449, 4);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:456:1: operator returns [Operator operator] : ( EQUALS | NOT_EQUALS | LIKE | NOT_LIKE | LT | GT | LTEQ | GTEQ | IN | IS NOT | IS | NOT IN | WAS | WAS NOT | WAS IN | WAS NOT IN | CHANGED );
	...
	private Operator @operator()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:457:2: ( EQUALS | NOT_EQUALS | LIKE | NOT_LIKE | LT | GT | LTEQ | GTEQ | IN | IS NOT | IS | NOT IN | WAS | WAS NOT | WAS IN | WAS NOT IN | CHANGED )
			int alt11=17;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:457:4: EQUALS
				{
				DebugLocation(457, 4);
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:458:4: NOT_EQUALS
				{
				DebugLocation(458, 4);
			...
			case 3:
				DebugEnterAlt(3);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:459:4: LIKE
				{
				DebugLocation(459, 4);
			...
			case 4:
				DebugEnterAlt(4);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:460:4: NOT_LIKE
				{
				DebugLocation(460, 4);
			...
			case 5:
				DebugEnterAlt(5);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:461:4: LT
				{
				DebugLocation(461, 4);
			...
			case 6:
				DebugEnterAlt(6);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:462:4: GT
				{
				DebugLocation(462, 4);
			...
			case 7:
				DebugEnterAlt(7);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:463:4: LTEQ
				{
				DebugLocation(463, 4);
			...
			case 8:
				DebugEnterAlt(8);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:464:4: GTEQ
				{
				DebugLocation(464, 4);
			...
			case 9:
				DebugEnterAlt(9);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:465:4: IN
				{
				DebugLocation(465, 4);
			...
			case 10:
				DebugEnterAlt(10);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:466:4: IS NOT
				{
				DebugLocation(466, 4);
			...
			case 11:
				DebugEnterAlt(11);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:467:4: IS
				{
				DebugLocation(467, 4);
			...
			case 12:
				DebugEnterAlt(12);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:468:4: NOT IN
				{
				DebugLocation(468, 4);
			...
			case 13:
				DebugEnterAlt(13);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:469:4: WAS
				{
				DebugLocation(469, 4);
			...
			case 14:
				DebugEnterAlt(14);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:470:4: WAS NOT
				{
				DebugLocation(470, 4);
			...
			case 15:
				DebugEnterAlt(15);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:471:7: WAS IN
				{
				DebugLocation(471, 7);
			...
			case 16:
				DebugEnterAlt(16);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:472:7: WAS NOT IN
				{
				DebugLocation(472, 7);
			...
			case 17:
				DebugEnterAlt(17);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:473:7: CHANGED
				{
				DebugLocation(473, 7);
	...
	// $ANTLR start "field"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:518:1: field returns [FieldReference field] : (num= numberString | ( (str= string |cf= customField ) ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )* ) );
	[GrammarRule("field")]
	private JqlParser.field_return field()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:527:2: (num= numberString | ( (str= string |cf= customField ) ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )* ) )
			int alt15=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:528:5: num= numberString
				{
				DebugLocation(528, 9);
				...
				DebugLocation(528, 24);
				 names.Add((num!=null?((JqlParser.numberString_return)num).@string:default(String))); 

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:530:5: ( (str= string |cf= customField ) ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )* )
				{
				DebugLocation(530, 5);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:530:5: ( (str= string |cf= customField ) ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )* )
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:531:9: (str= string |cf= customField ) ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )*
				{
				DebugLocation(531, 9);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:531:9: (str= string |cf= customField )
				int alt12=2;
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:532:13: str= string
					{
				...
				case 2:
					DebugEnterAlt(2);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:533:15: cf= customField
					{
				...
				DebugLocation(535, 9);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:535:9: ( ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )* )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:536:10: ( LBRACKET (ref= argument ) RBRACKET ) (ref= propertyArgument )*
						{
						DebugLocation(536, 10);
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:536:10: ( LBRACKET (ref= argument ) RBRACKET )
						DebugEnterAlt(1);
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:537:14: LBRACKET (ref= argument ) RBRACKET
						{
						DebugLocation(537, 14);
						Match(input,LBRACKET,Follow._LBRACKET_in_field856); 
						DebugLocation(538, 14);
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:538:14: (ref= argument )
						DebugEnterAlt(1);
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:539:18: ref= argument
						{
						...
						// ../../QuoteFlow/Models/Search/Jql/Jql.g:543:10: (ref= propertyArgument )*
						...
						while (true)
						{
							...
							case 1:
								DebugEnterAlt(1);
								// ../../QuoteFlow/Models/Search/Jql/Jql.g:544:14: ref= propertyArgument
								{
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:578:1: customField returns [string field] : CUSTOMFIELD LBRACKET posnum= POSNUMBER RBRACKET ;
	...
	private string customField()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:579:5: ( CUSTOMFIELD LBRACKET posnum= POSNUMBER RBRACKET )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:579:7: CUSTOMFIELD LBRACKET posnum= POSNUMBER RBRACKET
			{
			DebugLocation(579, 7);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:605:1: fieldCheck returns [FieldReference field] : f= field EOF ;
	...
	private FieldReference fieldCheck()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:606:2: (f= field EOF )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:606:4: f= field EOF
			{
			DebugLocation(606, 6);
	...
	// $ANTLR start "operand"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:612:1: operand returns [IOperand operand] : ( EMPTY |str= string |number= numberString |fn= func |l= list );
	[GrammarRule("operand")]
	private IOperand operand()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:613:2: ( EMPTY |str= string |number= numberString |fn= func |l= list )
			int alt16=5;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:613:4: EMPTY
				{
				DebugLocation(613, 4);
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:614:4: str= string
				{
				DebugLocation(614, 8);
				...
				DebugLocation(614, 17);
				 operand = new SingleValueOperand((str!=null?((JqlParser.string_return)str).@string:default(String))); 

				}
				break;
			case 3:
				DebugEnterAlt(3);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:615:4: number= numberString
				{
			...
			case 4:
				DebugEnterAlt(4);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:616:4: fn= func
				{
				DebugLocation(616, 7);
			...
			case 5:
				DebugEnterAlt(5);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:617:4: l= list
				{
				DebugLocation(617, 6);
	...
	// $ANTLR start "string"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:656:1: string returns [String string] : (str= STRING |str= QUOTE_STRING |str= SQUOTE_STRING );
	[GrammarRule("string")]
	private JqlParser.string_return @string()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:657:2: (str= STRING |str= QUOTE_STRING |str= SQUOTE_STRING )
			int alt17=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:657:4: str= STRING
				{
				DebugLocation(657, 8);
				str=(IToken)Match(input,STRING,Follow._STRING_in_string1192); 
				DebugLocation(657, 17);
				 retval.@string = (str!=null?str.Text:default(string)); 

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:658:4: str= QUOTE_STRING
				{
				DebugLocation(658, 8);
			...
			case 3:
				DebugEnterAlt(3);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:659:4: str= SQUOTE_STRING
				{
				DebugLocation(659, 8);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:662:1: numberString returns [String string] : num= ( POSNUMBER | NEGNUMBER ) ;
	...
	private JqlParser.numberString_return numberString()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:663:2: (num= ( POSNUMBER | NEGNUMBER ) )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:663:4: num= ( POSNUMBER | NEGNUMBER )
			{
			DebugLocation(663, 8);
			...
			DebugLocation(663, 34);
			 retval.@string = (num!=null?num.Text:default(string)); 
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:669:1: stringValueCheck returns [String string] : str= string EOF ;
	...
	private String stringValueCheck()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:670:2: (str= string EOF )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:670:4: str= string EOF
			{
			DebugLocation(670, 8);
			...
			DebugLocation(670, 17);
			 @string = (str!=null?((JqlParser.string_return)str).@string:default(String)); 
	...
	// $ANTLR start "list"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:676:1: list returns [IOperand list] : LPAREN opnd= operand ( COMMA opnd= operand )* RPAREN ;
	[GrammarRule("list")]
	private IOperand list()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:684:2: ( LPAREN opnd= operand ( COMMA opnd= operand )* RPAREN )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:684:4: LPAREN opnd= operand ( COMMA opnd= operand )* RPAREN
			{
			DebugLocation(684, 4);
			...
			args.Add(opnd);
			DebugLocation(685, 3);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:685:3: ( COMMA opnd= operand )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:685:4: COMMA opnd= operand
					{
					DebugLocation(685, 4);
	...
	// $ANTLR start "func"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:702:1: func returns [FunctionOperand func] : fname= funcName LPAREN ( arglist )? RPAREN ;
	[GrammarRule("func")]
	private FunctionOperand func()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:703:2: (fname= funcName LPAREN ( arglist )? RPAREN )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:703:4: fname= funcName LPAREN ( arglist )? RPAREN
			{
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:703:28: ( arglist )?
			int alt19=2;
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:737:1: funcName returns [string name] : ( string |num= numberString );
	...
	private string funcName()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:738:2: ( string |num= numberString )
			int alt20=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:738:4: string
				{
				DebugLocation(738, 4);
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:739:4: num= numberString
				{
				DebugLocation(739, 8);
				...
				DebugLocation(739, 23);
				 name = (num!=null?((JqlParser.numberString_return)num).@string:default(String)); 
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:745:1: funcNameCheck returns [string name] : fname= funcName EOF ;
	...
	private string funcNameCheck()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:746:2: (fname= funcName EOF )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:746:4: fname= funcName EOF
			{
	...
	// $ANTLR start "arglist"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:752:1: arglist returns [List<string> args] : str= argument ( COMMA str= argument )* ;
	[GrammarRule("arglist")]
	private List<string> arglist()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:766:2: (str= argument ( COMMA str= argument )* )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:766:4: str= argument ( COMMA str= argument )*
			{
			DebugLocation(766, 8);
			...
			DebugLocation(766, 19);
			 args.Add(str); 
			DebugLocation(767, 2);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:767:2: ( COMMA str= argument )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:767:3: COMMA str= argument
					{
					DebugLocation(767, 3);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:770:1: propertyArgument returns [string arg] : a= argument ;
	...
	private string propertyArgument()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:771:2: (a= argument )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:771:4: a= argument
			{
			DebugLocation(771, 6);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:795:1: argument returns [string arg] : (str= string |number= numberString );
	...
	private string argument()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:796:2: (str= string |number= numberString )
			int alt22=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:796:4: str= string
				{
				DebugLocation(796, 8);
				...
				DebugLocation(796, 17);
				 arg = (str!=null?((JqlParser.string_return)str).@string:default(String)); 

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:797:4: number= numberString
				{
				...
				DebugLocation(797, 26);
				 arg = (number!=null?((JqlParser.numberString_return)number).@string:default(String)); 
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:819:1: argumentCheck returns [string arg] : a= argument EOF ;
	...
	private string argumentCheck()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:820:2: (a= argument EOF )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:820:4: a= argument EOF
			{
			DebugLocation(820, 6);
	...
	// $ANTLR start "orderBy"
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:826:1: orderBy returns [IOrderBy order] : ORDER BY f= searchSort ( COMMA f= searchSort )* ;
	[GrammarRule("orderBy")]
	private IOrderBy orderBy()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:830:2: ( ORDER BY f= searchSort ( COMMA f= searchSort )* )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:830:4: ORDER BY f= searchSort ( COMMA f= searchSort )*
			{
			DebugLocation(830, 4);
			...
			DebugLocation(830, 28);
			 args.Add(f); 
			DebugLocation(831, 3);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:831:3: ( COMMA f= searchSort )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// ../../QuoteFlow/Models/Search/Jql/Jql.g:831:4: COMMA f= searchSort
					{
					DebugLocation(831, 4);
	...
	// ../../QuoteFlow/Models/Search/Jql/Jql.g:857:1: searchSort returns [SearchSort sort] : f= field (o= DESC |o= ASC )? ;
	...
	private SearchSort searchSort()
	{
		...
		try
		{
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:858:2: (f= field (o= DESC |o= ASC )? )
			DebugEnterAlt(1);
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:858:4: f= field (o= DESC |o= ASC )?
			{
			DebugLocation(858, 6);
			...
			// ../../QuoteFlow/Models/Search/Jql/Jql.g:858:14: (o= DESC |o= ASC )?
			int alt24=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:858:15: o= DESC
				{
			...
			case 2:
				DebugEnterAlt(2);
				// ../../QuoteFlow/Models/Search/Jql/Jql.g:858:26: o= ASC
				{
	...
	{
		public static readonly BitSet _clause_in_query85 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _orderBy_in_query95 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_query99 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _orClause_in_clause135 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _andClause_in_orClause166 = new BitSet(new ulong[]{0x400000000002UL});
		public static readonly BitSet _OR_in_orClause171 = new BitSet(new ulong[]{0xC14048400020200UL});
		public static readonly BitSet _andClause_in_orClause177 = new BitSet(new ulong[]{0x400000000002UL});
		public static readonly BitSet _notClause_in_andClause210 = new BitSet(new ulong[]{0x82UL});
		public static readonly BitSet _AND_in_andClause215 = new BitSet(new ulong[]{0xC14048400020200UL});
		public static readonly BitSet _notClause_in_andClause221 = new BitSet(new ulong[]{0x82UL});
		public static readonly BitSet _set_in_notClause244 = new BitSet(new ulong[]{0xC14048400020200UL});
		public static readonly BitSet _notClause_in_notClause256 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _subClause_in_notClause263 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _terminalClause_in_notClause291 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _LPAREN_in_subClause323 = new BitSet(new ulong[]{0xC14048400020200UL});
		public static readonly BitSet _orClause_in_subClause325 = new BitSet(new ulong[]{0x80000000000000UL});
		public static readonly BitSet _RPAREN_in_subClause327 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _field_in_terminalClause368 = new BitSet(new ulong[]{0x40001C1AD8402000UL});
		public static readonly BitSet _operator_in_terminalClause374 = new BitSet(new ulong[]{0x2C14208404301412UL});
		public static readonly BitSet _operand_in_terminalClause384 = new BitSet(new ulong[]{0x2000200004101412UL});
		public static readonly BitSet _historyPredicate_in_terminalClause389 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _historyPredicate_in_terminalClause397 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _terminalHistoryPredicate_in_historyPredicate437 = new BitSet(new ulong[]{0x2000200004101412UL});
		public static readonly BitSet _historyPredicateOperator_in_terminalHistoryPredicate461 = new BitSet(new ulong[]{0xC14008400200000UL});
		public static readonly BitSet _operand_in_terminalHistoryPredicate463 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _FROM_in_historyPredicateOperator482 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _TO_in_historyPredicateOperator489 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _BY_in_historyPredicateOperator496 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _BEFORE_in_historyPredicateOperator503 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _AFTER_in_historyPredicateOperator510 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ON_in_historyPredicateOperator517 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _DURING_in_historyPredicateOperator525 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _EQUALS_in_operator546 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _NOT_EQUALS_in_operator553 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _LIKE_in_operator560 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _NOT_LIKE_in_operator567 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _LT_in_operator575 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _GT_in_operator582 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _LTEQ_in_operator589 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _GTEQ_in_operator596 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IN_in_operator603 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IS_in_operator610 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _NOT_in_operator612 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IS_in_operator619 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _NOT_in_operator626 = new BitSet(new ulong[]{0x40000000UL});
		public static readonly BitSet _IN_in_operator628 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _WAS_in_operator635 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _WAS_in_operator642 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _NOT_in_operator644 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _WAS_in_operator654 = new BitSet(new ulong[]{0x40000000UL});
		public static readonly BitSet _IN_in_operator656 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _WAS_in_operator666 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _NOT_in_operator668 = new BitSet(new ulong[]{0x40000000UL});
		public static readonly BitSet _IN_in_operator670 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _CHANGED_in_operator680 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _numberString_in_field744 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _string_in_field786 = new BitSet(new ulong[]{0x100000002UL});
		public static readonly BitSet _customField_in_field808 = new BitSet(new ulong[]{0x100000002UL});
		public static readonly BitSet _LBRACKET_in_field856 = new BitSet(new ulong[]{0xC14008000000000UL});
		public static readonly BitSet _argument_in_field894 = new BitSet(new ulong[]{0x20000000000000UL});
		public static readonly BitSet _RBRACKET_in_field926 = new BitSet(new ulong[]{0xC14008100000002UL});
		public static readonly BitSet _propertyArgument_in_field967 = new BitSet(new ulong[]{0xC14008100000002UL});
		public static readonly BitSet _CUSTOMFIELD_in_customField1037 = new BitSet(new ulong[]{0x100000000UL});
		public static readonly BitSet _LBRACKET_in_customField1039 = new BitSet(new ulong[]{0x4000000000000UL});
		public static readonly BitSet _POSNUMBER_in_customField1045 = new BitSet(new ulong[]{0x20000000000000UL});
		public static readonly BitSet _RBRACKET_in_customField1047 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _field_in_fieldCheck1087 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_fieldCheck1091 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _EMPTY_in_operand1108 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _string_in_operand1119 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _numberString_in_operand1130 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _func_in_operand1141 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _list_in_operand1152 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _STRING_in_string1192 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _QUOTE_STRING_in_string1203 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SQUOTE_STRING_in_string1214 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _set_in_numberString1235 = new BitSet(new ulong[]{0x2UL});
		...
		public static readonly BitSet _LPAREN_in_list1298 = new BitSet(new ulong[]{0xC14008400200000UL});
		public static readonly BitSet _operand_in_list1304 = new BitSet(new ulong[]{0x80000000004000UL});
		public static readonly BitSet _COMMA_in_list1312 = new BitSet(new ulong[]{0xC14008400200000UL});
		public static readonly BitSet _operand_in_list1318 = new BitSet(new ulong[]{0x80000000004000UL});
		public static readonly BitSet _RPAREN_in_list1324 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _funcName_in_func1362 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _LPAREN_in_func1364 = new BitSet(new ulong[]{0xC94008000000000UL});
		public static readonly BitSet _arglist_in_func1366 = new BitSet(new ulong[]{0x80000000000000UL});
		public static readonly BitSet _RPAREN_in_func1369 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _string_in_funcName1406 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _numberString_in_funcName1417 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _funcName_in_funcNameCheck1441 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_funcNameCheck1445 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _argument_in_arglist1478 = new BitSet(new ulong[]{0x4002UL});
		public static readonly BitSet _COMMA_in_arglist1484 = new BitSet(new ulong[]{0xC14008000000000UL});
		public static readonly BitSet _argument_in_arglist1490 = new BitSet(new ulong[]{0x4002UL});
		public static readonly BitSet _argument_in_propertyArgument1514 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _string_in_argument1536 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _numberString_in_argument1548 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _argument_in_argumentCheck1579 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_argumentCheck1583 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ORDER_in_orderBy1607 = new BitSet(new ulong[]{0x1000UL});
		public static readonly BitSet _BY_in_orderBy1609 = new BitSet(new ulong[]{0xC14008000020000UL});
		public static readonly BitSet _searchSort_in_orderBy1615 = new BitSet(new ulong[]{0x4002UL});
		public static readonly BitSet _COMMA_in_orderBy1622 = new BitSet(new ulong[]{0xC14008000020000UL});
		public static readonly BitSet _searchSort_in_orderBy1628 = new BitSet(new ulong[]{0x4002UL});
		public static readonly BitSet _field_in_searchSort1671 = new BitSet(new ulong[]{0x40102UL});
		public static readonly BitSet _DESC_in_searchSort1678 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ASC_in_searchSort1686 = new BitSet(new ulong[]{0x2UL});
	}
