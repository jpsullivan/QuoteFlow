...
namespace QuoteFlow.Models.Assets.Fields
{
    ...
    public interface IOrderableField : IField, ISearchableField
    {
        ...
        void PopulateDefaults(IDictionary<string, object> fieldValuesHolder, Asset asset);
        ...
        /// <param name="fieldValuesHolder">The fieldValuesHolder Map to be populated.</param>
        /// <param name="asset">The asset.</param>
        void PopulateFromAsset(IDictionary<string, object> fieldValuesHolder, Asset asset);
        ...
        void PopulateParamsFromString(IDictionary<string, object> fieldValuesHolder, string stringValue, Asset asset);
    }
}