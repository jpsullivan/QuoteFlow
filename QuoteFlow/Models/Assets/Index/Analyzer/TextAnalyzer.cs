...
{
    /// <summary>
    /// An <seealso cref="QuoteFlow.Models.Assets.Index.Analyzer"/> base class that provides the facility to apply the <seealso cref="SubtokenFilter"/>
    ...
    /// </summary>
    public abstract class TextAnalyzer : Lucene.Net.Analysis.Analyzer
    {
