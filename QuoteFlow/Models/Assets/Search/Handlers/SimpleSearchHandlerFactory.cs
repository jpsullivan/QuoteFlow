...
namespace QuoteFlow.Models.Assets.Search.Handlers
{
    public abstract class SimpleSearchHandlerFactory : ISearchHandlerFactory
    {
        ...
        private readonly IFactory clausePermissionFactory;
        ...
        /// </summary>
        /// <param name="information">The string information (clause names, index field, field id) associated with this clause handler.</param>
        ...
        /// <param name="clauseValidator">The validatr to place in the handler.</param>
        ...
        public SimpleSearchHandlerFactory(IClauseInformation information, Type searcherClass, IClauseQueryFactory queryFactory, IClauseValidator clauseValidator, IClauseContextFactory clauseContextFactory, IClauseValuesGenerator clauseValuesGenerator)
            : this(information, searcherClass, queryFactory, clauseValidator, clauseContextFactory, clauseValuesGenerator, null)
        {
        }
        ...
        public SimpleSearchHandlerFactory(IClauseInformation information, Type searcherClass, IClauseQueryFactory queryFactory, IClauseValidator clauseValidator, IClauseContextFactory clauseContextFactory, IClauseValuesGenerator clauseValuesGenerator, IClauseSanitizer sanitizer)
        {
        ...
        public SearchHandler CreateHandler(ISearchableField field)
        {
            ...
            {
                clauseHandler = new ClauseHandler(clauseInformation, queryFactory, clauseValidator, clauseContextFactory);
            }
            else
            {
                clauseHandler = new ValuesGeneratingClauseHandler(clauseInformation, queryFactory, clauseValidator, clauseContextFactory, clauseValuesGenerator);
            }
