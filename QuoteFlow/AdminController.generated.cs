...
namespace QuoteFlow.Controllers.Admin
{
    public partial class AdminController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string AdminIndex = "~/Views/Admin/AdminIndex.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminController : QuoteFlow.Controllers.Admin.AdminController
    {
        public T4MVC_AdminController() : base(Dummy.Instance) { }

        [NonAction]
        partial void AdminIndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult AdminIndex()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.AdminIndex);
            AdminIndexOverride(callInfo);
            return callInfo;
        }
