...
var EventTypes = require('../../modules/asset-nav/util/types');
...
/**
 * A single select list that can be queried and suggestions selected via a dropdown.
 * Suggestions are retrieved via AJAX or Statically.
 *
 * @class SingleSelect
 * @extends QueryableDropdownSelect
 */
var SingleSelect = QueryableDropdownSelect.extend({
